      ...
      <article className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-gray max-w-none space-y-8 text-gray-700 leading-relaxed">
          <section>
            ...
            <p>Most agencies assume clients leave after a bad month because of the performance. That&apos;s rarely true. Clients are sophisticated enough to know that marketing doesn&apos;t always work perfectly. What they cannot tolerate is not knowing why.</p>
          ...
          <section>
            ...
            <p>This is the most underrated element of client communication — and one of the most powerful things you can do to reinforce trust during a difficult month.</p>
